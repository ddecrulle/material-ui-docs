...
module.exports = {
  ...
  // next.config.js redirects is for developement. It does not work when run `next export`
  // For production redirects, configure at `docs/public/_redirects` (netlify).
  async redirects() {
