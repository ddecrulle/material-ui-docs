...
If you are using TypeScript, you will also need to use [module augmentation](/material/guides/typescript/#customization-of-theme) for the theme to accept the above values.
...
[`Box`](/material/react-box/) is a lightweight component that gives access to the `sx` prop, and can be used as a utility component, and as a wrapper for other components.
