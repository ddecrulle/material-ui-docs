...
Você pode [seguir o guia de renderização no servidor](/material/guides/server-rendering/) para um exemplo mais detalhado, ou leia o [`ServerStyleSheets` na documentação da API](/system/styles/api/#serverstylesheets).
