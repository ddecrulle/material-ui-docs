...
for controlling the layout of your application through the [Grid](/material/react-grid/) component.
...
You can learn more on the [useMediaQuery](/material/react-use-media-query/) page.
...
If you are using TypeScript, you would also need to use [module augmentation](/material/guides/typescript/#customization-of-theme) for the theme to accept the above values.
