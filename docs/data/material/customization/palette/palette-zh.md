...
如果想要了解更多关于色彩的知识，您可以查看 [色彩章节](/material/customization/color/)。

## 默认值

通过[主题资源管理器](/material/customization/default-theme/?expand-path=$.palette)或通过打开此页面上的开发工具控制台（dev tools console）（`window.theme.palette`），您可以浏览调色板的默认值。
...
调色板颜色值可以是[颜色（color）](/material/customization/color/#2014-material-design-color-palettes)对象，也可以是具有以下 TypeScript 接口指定的一个或多个键（key）的对象：
...
如果您使用的是 TypeScript，您还需要使用 [module augmentation](/material/guides/typescript/#customization-of-theme) 来让主题接受上述值。
...
需要灵感吗？ Material Design 团队已经建立了一个[调色板配置工具](/material/customization/color/#picking-colors)来帮助您选择颜色。
