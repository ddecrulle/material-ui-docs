...
Se você quiser aprender mais sobre cor, você pode conferir [a seção de cores](/material/customization/color/).

## Valores padrão

Você pode explorar os valores padrão da paleta usando [o explorador de tema](/material/customization/default-theme/?expand-path=$.palette) ou abrindo o console das ferramentas de desenvolvimento nesta página (`window.theme.palette`).
...
- [`.palette.primary`](/material/customization/default-theme/?expand-path=$.palette.primary)
- [`.palette.secondary`](/material/customization/default-theme/?expand-path=$.palette.secondary)
- [`.palette.error`](/material/customization/default-theme/?expand-path=$.palette.error)
- [`.palette.warning`](/material/customization/default-theme/?expand-path=$.palette.warning)
- [`.palette.info`](/material/customization/default-theme/?expand-path=$.palette.info)
- [`.palette.success`](/material/customization/default-theme/?expand-path=$.palette.success)

objetos de cores da paleta são fornecidos, eles substituirão os padrões.

O valor da paleta de cor pode ser um objeto [cor](/material/customization/color/#2014-material-design-color-palettes), ou um objeto com uma ou mais das chaves especificadas pela seguinte interface TypeScript:
...
Precisa de inspiração? A equipe do Material Design construiu uma [ferramenta de configuração de paleta](/material/customization/color/#picking-colors) para te ajudar.
