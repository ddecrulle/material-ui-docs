...
Você pode utilizar essa preferência dinamicamente com o hook [useMediaQuery](/material/react-use-media-query/) e a consulta de mídia [prefers-color-scheme](https://developer.mozilla.org/en-US/docs/Web/CSS/@media/prefers-color-scheme).
