...
In order to globally define Raleway as a font face, the [`CssBaseline`](/material/react-css-baseline/) component can be used (or any other CSS solution of your choice).
...
You can use [media queries](/material/customization/breakpoints/#api) inside them:
...
To automate this setup, you can use the [`responsiveFontSizes()`](/material/customization/theming/#responsivefontsizes-theme-options-theme) helper to make Typography font sizes in the theme responsive.

{{"demo": "ResponsiveFontSizesChart.js", "hideToolbar": true}}

You can see this in action in the example below. Adjust your browser's window size, and notice how the font size changes as the width crosses the different [breakpoints](/material/customization/breakpoints/):
...
The typography object comes with [13 variants](/material/react-typography/#component) by default:
...
You can explore the default values of the typography using [the theme explorer](/material/customization/default-theme/?expand-path=$.typography) or by opening the dev tools console on this page (`window.theme.typography`).
