...
Você pode utilizar um [componente de transição](/material/transitions/) como um `Collapse` para realizar uma transição na exibição do alerta.
...
Você pode alterar a severidade padrão e o mapeamento do ícone com a propriedade `iconMapping`. Isso pode ser definido globalmente utilizando a [customização do tema](/material/customization/theme-components/#default-props).
...
Você pode usar o componente Snackbar para [exibir um toast](/material/react-snackbar/#customized-snackbars) com o componente Alert.
