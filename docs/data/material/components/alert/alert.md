...
You can use a [transition component](/material/transitions/) such as `Collapse` to transition the appearance of the alert.
...
You can change the default severity to icon mapping with the `iconMapping` prop. This can be defined globally using [theme customization](/material/customization/theme-components/#default-props).
...
You can use the Snackbar to [display a toast](/material/react-snackbar/#customized-snackbars) with the Alert.
