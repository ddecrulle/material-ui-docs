...
- O componente é construído sobre o componente [`Modal`](/material/react-modal/).
- A rolagem e o clique fora não é permitido, ao contrário do componente [`Popper`](/material/react-popper/).
