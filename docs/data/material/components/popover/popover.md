...
- The component is built on top of the [`Modal`](/material/react-modal/) component.
- The scroll and click away are blocked unlike with the [`Popper`](/material/react-popper/) component.
