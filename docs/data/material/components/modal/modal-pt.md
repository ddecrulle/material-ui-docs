...
Se você está criando um diálogo modal, você provavelmente quer usar o componente [Dialog](/material/react-dialog/) em vez de diretamente um Modal. Modal é uma estrutura de baixo-nível que é aproveitada pelos seguintes componentes:

- [Dialog](/material/react-dialog/)
- [Drawer](/material/react-drawer/)
- [Menu](/material/react-menu/)
- [Popover](/material/react-popover/)
