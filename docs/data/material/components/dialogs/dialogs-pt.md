...
Você pode fazer um diálogo totalmente responsivo usando [`useMediaQuery`](/material/react-use-media-query/#usemediaquery).
...
Veja a seção [Performance Modal](/material/react-modal/#performance).

## Limitações

Siga a [seção de limitações do Modal](/material/react-modal/#limitations).

## Acessibilidade

Siga a [seção de acessibilidade do Modal](/material/react-modal/#accessibility).
