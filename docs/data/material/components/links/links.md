...
The Link component is built on top of the [Typography](/material/api/typography/) component, meaning that you can use its props.
...
Here is a [more detailed guide](/material/guides/routing/#link).
