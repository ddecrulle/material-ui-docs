...
If you want to switch the styled-engine to use styled-components, [follow this guide](/material/guides/styled-engine/#how-to-switch-to-styled-components).
...
For more details, check out the [unstyled components page](/material/customization/unstyled-components/)
