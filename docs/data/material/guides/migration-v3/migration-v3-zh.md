...
我们在 [TypeScript 指南中](/material/guides/typescript/#handling-value-and-event-handlers)更详细地解释了此变更。
...
- [ButtonBase] 传递给`组件`的属性的组件需要能接受一个 ref。 我们在 [组合指南](/material/guides/composition/#caveat-with-refs) 中解释了迁移的策略。
...
- [Dialog] 子组件能够接受一个 ref。 我们在 [组合指南](/material/guides/composition/#caveat-with-refs) 中解释了迁移的策略。
...
- [Modal] 子组件能够接受一个 ref。 [组合指南](/material/guides/composition/#caveat-with-refs)解释了迁移的策略。
...
- [Portal] 当使用 `disablePortal`属性的时候，子元素需要能够接受一个 ref。 [组合指南](/material/guides/composition/#caveat-with-refs)解释了迁移的策略。

### Slide 滑动

- [Slide] 子组件能够接受一个 ref。 [组合指南](/material/guides/composition/#caveat-with-refs)解释了迁移的策略。
...
- [Tooltip] 子组件能够接受一个 ref。 [组合指南](/material/guides/composition/#caveat-with-refs)解释了迁移的策略。
