...
The `disableRipple` prop will flow this way: [`MenuItem`](/material/api/menu-item/) > [`ListItem`](/material/api/list-item/) > [`ButtonBase`](/material/api/button-base/).
...
All components accept a [`classes`](/material/customization/how-to-customize/#overriding-styles-with-class-names) prop to customize the styles.
...
- their own `xxxRef` prop when you might need to perform imperative actions,
  ...
  This helps answer the question ["How can I access the DOM element?"](/material/getting-started/faq/#how-can-i-access-the-dom-element)
