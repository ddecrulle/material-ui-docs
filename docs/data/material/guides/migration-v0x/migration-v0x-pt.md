...
- Nova solução de estilo usando CSS-in-JS (melhor poder de [customização](/material/customization/how-to-customize/), melhor desempenho)
...
- Melhor [cobertura de teste](/material/guides/testing/) (99%+, executado em todos os principais navegadores, [testes de regressão visual](https://www.argos-ci.com/mui-org/material-ui))
- Suporte completo [a renderização do lado do servidor](/material/guides/server-rendering/)
- Vasta gama de [navegadores suportados](/material/getting-started/supported-platforms/)
...
Material-UI, não fornece uma API de alto nível para resolver este problema. Recomendamos que você explore [as soluções que a comunidade construiu](/material/react-autocomplete/).
