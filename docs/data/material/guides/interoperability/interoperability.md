...
[You can target the class names generated by MUI](/system/styles/advanced/#with-material-ui-core).
...
however, you would like to use `styled-components`, you can configure your app by following the [styled engine guide](/material/guides/styled-engine/#how-to-switch-to-styled-components) or starting with one of the example projects:
...
The [Portal](/material/react-portal/) provides a first-class way to render children into a DOM node that exists outside the DOM hierarchy of the parent component.
Because of the way styled-components scopes its CSS, you may run into issues where styling is not applied.

For example, if you attempt to style the `tooltip` generated by the [Tooltip](/material/react-tooltip/) component,
...
It works exactly like styled components. You can [use the same guide](/material/guides/interoperability/#styled-components).
