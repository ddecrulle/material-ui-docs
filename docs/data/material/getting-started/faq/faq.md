...
If you still can't find what you're looking for, you can refer to our [support page](/material/getting-started/support/).
...
[Style Library Interoperability](/material/guides/interoperability/) section,
...
We detail the [integration with third-party routing libraries](/material/guides/routing/) like react-router, Gatsby or Next.js in our guide.
...
can check the API documentation under "Props" e.g. the [Button API](/material/api/button/#props)
includes
...
Check out the [reference implementations](/material/guides/server-rendering/#reference-implementations), bit by bit.
...
page](/material/customization/theming/) to learn about theme customization.

## Why does component X require a DOM node in a prop instead of a ref object?

Components like the [Portal](/material/api/portal/#props) or [Popper](/material/api/popper/#props) require a DOM node in the `container` or `anchorEl` prop respectively.
