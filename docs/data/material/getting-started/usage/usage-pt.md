...
Você pode usar qualquer um dos componentes conforme demonstrado na documentação. Por favor, consulte a [página de demonstração](/material/react-button/) de cada componente para ver como eles devem ser importados.
...
MUI fornece um componente opcional [CssBaseline](/material/react-css-baseline/). Ele corrige algumas inconsistências nos navegadores e dispositivos, ao mesmo tempo em que fornece redefinições ligeiramente mais opinativas para elementos HTML comuns.
...
- Como aplicar [a fonte e a tipografia do Material Design](/material/react-typography/).
